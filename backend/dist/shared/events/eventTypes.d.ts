...
export type PlatformEvent = UserRegisteredEvent | UserLocationUpdatedEvent | TeamCreatedEvent | TeamMemberAddedEvent | ResumeUploadedEvent | ResumeParsedEvent | AgentTaskStartedEvent | AgentTaskCompletedEvent | SessionStartedEvent | SessionEndedEvent | NotificationSentEvent | BaseEvent;
